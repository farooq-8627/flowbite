			...
			<PopoverContent align="start" className="flex w-auto flex-col gap-4">
				<div className="flex flex-col gap-3">
					...
					<div className="flex items-center gap-4">
						...
						<div className="relative">
							...
							<Input
								...
								onChange={(e) => {
									...
									if (!Number.isNaN(n) && n >= min && n <= range[1])
										column.setFilterValue([n, range[1]]);
								}}
						...
						<div className="relative">
							<Input
								...
								onChange={(e) => {
									const n = Number(e.target.value);
									if (!Number.isNaN(n) && n <= max && n >= range[0])
										column.setFilterValue([range[0], n]);
								}}
								className={cn("h-8 w-24", unit && "pe-8")}
							/>
							{unit && (
					...
					<Slider
						...
						value={range}
						onValueChange={(v) => {
							if (Array.isArray(v) && v.length === 2) column.setFilterValue(v);
						}}
					/>
				</div>
