...
export function LayoutControls() {
	...
	const navbar_style = usePreferencesStore((s) => s.navbar_style);
	...
	const onRadiusChange = (value: string | "") => {
		if (!value) return;
		setRadius(value);
		void persistPreference("radius", value);
	};
	...
	const handleRestore = () => {
		...
		onRadiusChange(PREFERENCE_DEFAULTS.radius);
				...
				<div className="flex flex-col gap-5">
					...
					<div className="space-y-3 **:data-[slot=toggle-group]:w-full **:data-[slot=toggle-group-item]:flex-1 **:data-[slot=toggle-group-item]:text-xs">
						<div className="space-y-1">
							...
							<Select value={theme_preset} onValueChange={onThemePresetChange}>
						...
						<div className="space-y-1">
							<Label className="font-medium text-xs">Border Radius</Label>
							<ToggleGroup
								size="sm"
								variant="outline"
								type="single"
							...
							>
								...
								<ToggleGroupItem value="0.3" aria-label="Small radius">
									0.3
								</ToggleGroupItem>
								<ToggleGroupItem value="0.5" aria-label="Medium radius">
									0.5
								</ToggleGroupItem>
								<ToggleGroupItem value="0.75" aria-label="Large radius">
									0.75
								</ToggleGroupItem>
								<ToggleGroupItem value="1.0" aria-label="Extra large radius">
									1.0
								</ToggleGroupItem>
							</ToggleGroup>
						</div>
