...
import { Building2, Briefcase, CheckCircle2, Orbit, Rocket } from "lucide-react";
      ...
      {STEPS.map((step, i) => (
        <div
          ...
          className={cn(
            ...
            i === current ? "w-6 bg-primary" : i < current ? "w-2 bg-primary/60" : "w-2 bg-muted-foreground/30",
          )}
        />
      ))}
...
function WorkspaceStep({
  ...
  onNext: (orgId: Id<"orgs">, slug: string) => void;
}) {
  ...
  return (
    <div className="mx-auto flex w-full flex-col justify-center space-y-8 sm:w-[350px]">
      ...
      <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
        ...
        <Field className="gap-1.5">
          ...
          >
            ...
            <input
              ...
              onChange={(e) => {
                setSlugEdited(true);
                setSlug(e.target.value.toLowerCase().replace(/[^a-z0-9-]/g, "").slice(0, 48));
              }}
              required
            />
          </div>
        ...
        <Button className="w-full" type="submit" disabled={loading || !name || !slug || slugTaken}>
    ...
    <div className="mx-auto flex w-full flex-col justify-center space-y-8 sm:w-[380px]">
      ...
      <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
        ...
        <div className="flex gap-3">
          ...
          <Button className="flex-1" type="submit" disabled={!industry || !teamSize || loading}>
