...
const ROLE_PERMISSIONS: Record<string, string[]> = {
	owner: [
		...
		"deals.view", "deals.create", "deals.update", "deals.delete", "deals.assign", "deals.changeStage", "deals.close",
	...
	admin: [
		"org.viewSettings", "org.editSettings",
	...
	viewer: [
		"members.view", "members.leave",
		"leads.view", "contacts.view", "companies.view", "deals.view",
		"notes.view", "reminders.view", "tags.view", "savedViews.view",
		"pipelines.view", "fieldDefinitions.view",
		"activityLogs.viewOwn", "notifications.viewOwn", "notifications.markRead",
		"ai.viewHistory",
	],
...
export async function seedOrgMember(ctx: any, orgId: any, userId: any, roleName: "owner" | "admin" | "member" | "viewer") {
	const now = Date.now();
