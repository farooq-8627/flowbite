		...
		<div className="flex flex-col gap-4 max-w-lg mx-auto">
			<div>
				...
				<p className="text-slate-600 dark:text-slate-400 mt-1">
					This app can generate random numbers and store them in your Convex database.
				</p>
			</div>
			...
			<div className="flex flex-col gap-4">
				...
				<p className="text-slate-600 dark:text-slate-400 text-sm">
					Click the button below to generate a new number. The data is persisted in the
					Convex cloud database - open this page in another window and see the data sync
					automatically!
				</p>
				<button
