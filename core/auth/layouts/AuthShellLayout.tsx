            ...
            <>
              ...
              <div className="absolute bottom-10 flex w-full justify-between px-10">
                <div className="flex-1 space-y-1 text-primary-foreground">
                  <h2 className="font-medium">{panel?.bottomLeft?.heading ?? "Built for your team"}</h2>
                  <p className="text-sm opacity-80">
                    {panel?.bottomLeft?.body ?? "Manage leads, contacts, and deals in one place."}
                  </p>
                </div>
                <Separator orientation="vertical" className="mx-3 h-auto opacity-30" />
                <div className="flex-1 space-y-1 text-primary-foreground">
                  <h2 className="font-medium">{panel?.bottomRight?.heading ?? "Need help?"}</h2>
                  <p className="text-sm opacity-80">
                    {panel?.bottomRight?.body ?? "Reach out to support — we're here for you."}
                  </p>
                </div>
              </div>
            </>
